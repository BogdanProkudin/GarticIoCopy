...
import styles from "../../../components/welcomePage/styles.module.scss";
import { MdClose } from "react-icons/md";
import WelcomeSelectAvatar from "../../welcomePage/userInfo/WelcomeSelectAvatar";
...
const PrepareRoomChangeAvatarModal: React.FC<ChangeAvatarModalProps> = ({
  isOpen,
  setIsOpen,
}) => {
  ...
  const avatars: string[] = !isBigScreen
    ? [
        ...
        "https://cdn.discordapp.com/attachments/1041468251093344317/1219256472228200518/image.png?ex=660aa413&is=65f82f13&hm=214a7f6b3f6ca0394d937a8c9dd74bb243fc7818986a7e4333beb8ac6a188c6e&",
...
export default PrepareRoomChangeAvatarModal;

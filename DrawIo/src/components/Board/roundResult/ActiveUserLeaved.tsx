...
const ActiveUserLeaved = () => {
  ...
  useEffect(() => {
    const handleUsersNotGuessed = () => {
      ...
      dispatch(setISActiveUserLeaved(false));
      dispatch(setIsUsersNotGuessed(false));
      dispatch(setIsUsersNotGuessedStarted(false));
    };

    socket.on("getActiveUserLeavedTimer", handleUsersNotGuessed);
    return () => {
      socket.off("getActiveUserLeavedTimer", handleUsersNotGuessed);
    };
  }, [socket]);
  return (
...
export default ActiveUserLeaved;
